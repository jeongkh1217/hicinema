...
public class Storecombo {
	...
	public ArrayList<Storegetset> storecombo(String orderby) throws Exception {				
				ArrayList<Storegetset> arr = new ArrayList<Storegetset>();	
				
				try{
					con();			
				ResultSet rs = stmt.executeQuery("select*from store where category='콤보' order by "+orderby+";");
