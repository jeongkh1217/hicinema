...
public class Storevoucher {
	...
	public ArrayList<Storegetset> storevoucher(String orderby) throws Exception {				
				ArrayList<Storegetset> arr = new ArrayList<Storegetset>();				
				try{
					con();			
				ResultSet rs = stmt.executeQuery("select*from store where category='상품권' order by "+orderby+";");
