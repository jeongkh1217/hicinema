...
public class Storesnack {
	...
	public ArrayList<Storegetset> storesnack(String orderby) throws Exception {				
				ArrayList<Storegetset> arr = new ArrayList<Storegetset>();				
				try{
					con();			
				ResultSet rs = stmt.executeQuery("select*from store where category='스낵' order by "+orderby+";");
